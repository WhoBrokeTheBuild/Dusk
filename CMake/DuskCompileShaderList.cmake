...
#
# For example:
#   ${CMAKE_CURRENT_SOURCE_DIR}/Assets/Shaders/Default.vert
# will be compiled and output to
#   ${CMAKE_BINARY_SOURCE_DIR}/Assets/Shaders/Default.vert.spv
#

macro(dusk_compile_shader_list _include_path _input_list _output_list)
    foreach(_input ${_input_list})

        # /path/to/Default.vert -> .vert
        ...
        if(_input_ext STREQUAL ".glsl")
            ...
            # Default.vert  -> .vert 
            get_filename_component(_input_ext "${_input_name}" LAST_EXT)

        else()

            # /path/to/Default.vert -> Default.vert 
            get_filename_component(_input_name "${_input}" NAME)

        endif()

        # /path/to/Default.vert -> /path/to/
        ...
        # .vert -> vert
        string(SUBSTRING "${_input_ext}" 1 -1 _stage)
